...
//	<1> a_filename != NULL
//	<2> The file exists
//	<3> The file is a 24-bit or 32-bit bitmap file
//  Returns: N/A
//  Side Effect: The contents of file a_filename are loaded into
//		 memory.  The new TextureBmp is not added to
//		 OpenGL.
//
...
//	<1> a_filename != NULL
//	<2> The file exists
//	<3> The file is a 24-bit bitmap file
//  Returns: N/A
//  Side Effect: The contents of file a_filename/filename are
//		 loaded into memory.  The texture is not added
//		 to OpenGL.  Any existing texture is lost.
//

...
//  isNormGreaterThan
//
//  Purpose: To determine if the norm of this Vector2 is
...
//  Precondition(s):
//	<1> length >= 0.0
//  Returns: Whether the norm of this Vector2 is less/greater
//	     than length.
//  Side Effect: N/A
//
...
//	     Vector2 and another Vector2 is less/greater than
...
//
	...
	double getChessboardDistance(const Vector2& other) const
	{
...
//
	...
	double cosAngle (const Vector2& other) const;
